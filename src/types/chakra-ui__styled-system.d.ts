...
declare module "@chakra-ui/styled-system" {
  export interface CustomThemeTypings extends BaseThemeTypings {
    ...
    colors:
      ...
      | "brand.secondary.600"
      | "brand.secondary.900"
      | "container.accent.dark"
      | "container.accent.light"
      | "container.danger.dark"
      | "container.danger.light"
      | "container.secondary.dark"
      ...
      | "surface.base.900"
      | "surface.base.950"
      | "surface.base.poolcard"
      | "surface.base.shadow"
      | "surface.base.trending"
      | "surface.brand.accent.100"
      | "surface.brand.secondary.100"
      | "surface.brand.secondary.900"
      | "surface.fast_launch"
      | (string & {});
    colorSchemes:
      | "whiteAlpha"
    ...
    components: {
      ...
      Container: {
        sizes: string & {};
        variants: "container.1080" | (string & {});
      };
      Divider: {
        sizes: string & {};
